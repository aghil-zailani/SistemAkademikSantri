...
@section('title', 'Edit User - eduSantri')
        ...
        <div class="p-8">
            ...
            <div class="mb-8">
                ...
                <div class="flex items-center space-x-6">
                    <div class="shrink-0">
                        @if($user->avatar)
                            <img id="avatarPreview" class="h-24 w-24 object-cover rounded-full border-4 border-gray-200" src="{{ Storage::url($user->avatar) }}" alt="Avatar">
                        @else
                            <img id="avatarPreview" class="h-24 w-24 object-cover rounded-full border-4 border-gray-200" src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&size=200&background=3b82f6&color=fff" alt="Avatar preview">
                        @endif
                    </div>
                    <label class="block">
                        ...
                        <p class="mt-2 text-xs text-gray-500">PNG, JPG, GIF hingga 2MB. Kosongkan jika tidak ingin mengubah</p>
                    </label>
                </div>
                @error('avatar')
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
                ...
                <div class="flex space-x-4">
                    <label class="flex items-center">
                        <input type="radio" name="status" value="active" {{ old('status', $user->status) == 'active' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Aktif</span>
                    </label>
                    <label class="flex items-center">
                        <input type="radio" name="status" value="inactive" {{ old('status', $user->status) == 'inactive' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 focus:ring-blue-500">
